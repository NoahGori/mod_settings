...
inline RED4ext::rtti::IType *ToType(const RED4ext::CName name) { return RED4ext::CRTTISystem::Get()->GetType(name); }

inline RED4ext::CClass *ToClass(const RED4ext::CName name) { return RED4ext::CRTTISystem::Get()->GetClass(name); }
