...
namespace Engine {
template <class T> class RTTIClassDescriptor : public RED4ext::TTypedClass<T>, public detail::TypeDescriptor<T> {
public:
  RTTIClassDescriptor() : RED4ext::TTypedClass<T>(0ull) {}

  void SetName(const char *aName) { RED4ext::CClass::name = RED4ext::CNamePool::Add(aName); }

  void SetFlags(const RED4ext::CClass::Flags &aFlags) { RED4ext::CClass::flags = aFlags; }
  ...
  inline static void RegisterRTTI() { s_registrar.Register(); }

  inline static RED4ext::CClass *Get() { return s_class; }
...
public:
  ...
  RED4ext::CClass *GetNativeType() override { return Descriptor::Get(); }
  ...
  inline static RED4ext::Handle<T> NewInstance(RED4ext::CClass *aDerived = nullptr) {
    ...
    scriptable->nativeType = type;

    return std::move(handle);
  }

  inline static RED4ext::CClass *GetRTTIType() { return Descriptor::Get(); }

  inline static RED4ext::CName GetRTTIName() { return Descriptor::Get()->GetName(); }

  inline static void RegisterRTTI() { Descriptor::RegisterRTTI(); }
