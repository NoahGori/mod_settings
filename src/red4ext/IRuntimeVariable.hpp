...
public:
  ...
  IRuntimeVariable(RED4ext::CName modName, RED4ext::CName className, RED4ext::CName propertyName,
                   RED4ext::CName displayName, RED4ext::CName description, uint32_t order);

  // custom virtuals
  virtual void __fastcall GetValueToWrite(char *value) = 0;
  virtual void *__fastcall GetRequestedValue() = 0;
  virtual void *__fastcall GetAcceptedValue() = 0;
